function IconClone(props: {width: string, height: string}) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={props.width} height={props.height} fill="#ffffff">
