...
export default function EditUser() {
  return (
    <Edit redirect="list" title="Modifier un utilisateur">
      <SimpleForm>
        ...
        <Grid container width="100%" spacing={2}>
          ...
          <Grid item xs={12}>
            ...
            <Box flex={1} mr="0.5em">
              <PasswordInput source="plainPassword" fullWidth name="plainPassword" label="Mot de passe" validate={[minLength(8), regex(/^[a-zA-Z0-9]+$/, 'Uniquement les lettres minuscules, majuscules et les chiffres sont autorisées')]}/>
            </Box>
          </Grid>
        </Grid>
      </SimpleForm>
